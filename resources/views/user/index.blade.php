...
<script>
    ...
    $('#address').on('change', function() {
        axios.post('{{ route('user.profile_account.address.store') }}', {id: $(this).val()}).then(function (response) {
            ...
            var link = "https://www.google.com/maps/embed/v1/place?key=AIzaSyC0cxbPtjuB3gxlsG1ieliBJrmAIqF6mG8&language=id&q="+response.data.villages_name+", "+response.data.districts_name+" &center="+meta.lat+","+meta.long+"";
